(function(root, factory) {
  if (typeof module === 'object' && module.exports) {
    ...
    root.calculateEtaSeconds = api.calculateEtaSeconds;
    root.calculateDeltaSeconds = api.calculateDeltaSeconds;
    root.buildEventEntry = api.buildEventEntry;
    root.sortEventEntries = api.sortEventEntries;
  }
})(typeof globalThis !== 'undefined' ? globalThis : this, function() {
  function calculateEtaSeconds(distMeters, detour, speedMps) {
    return (distMeters * detour) / speedMps;
  }

  function calculateDeltaSeconds(etaSeconds, dtAnchorSec) {
  ...
  function sortEventEntries(entries, options) {
