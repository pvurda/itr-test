(function(root, factory) {
  if (typeof module === 'object' && module.exports) {
    ...
    root.buildDetectionsExportPayload = api.buildDetectionsExportPayload;
    root.buildNeighborCsvRows = api.buildNeighborCsvRows;
  }
})(typeof globalThis !== 'undefined' ? globalThis : this, function() {
  function buildDetectionsExportPayload(options) {
    return {
      v: 1,
  ...
  function buildNeighborCsvRows(options) {
  ...
  return {buildDetectionsExportPayload, buildNeighborCsvRows};
});
